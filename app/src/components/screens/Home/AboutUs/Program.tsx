    ...
    <div className={sharedStyles['about-blocks']}>
      <div className={sharedStyles['about-block']}>
        ...
        <div className={sharedStyles['about-block-text']}>
          ...
          <p>
            Пізнання та прийняття себе. Нагода краще зрозуміти себе та відкрити у собі таланти для подальшого їх
            розвитку.
          </p>
        </div>
      </div>
      ...
      <div className={sharedStyles['about-block']}>
        ...
        <div className={sharedStyles['about-block-text']}>
          ...
          <p>Можливість всебічно розвиватися завдяки запропонованій навчальній програмі.</p>
        </div>
      </div>
      ...
      <div className={sharedStyles['about-block']}>
        ...
        <div className={sharedStyles['about-block-text']}>
          ...
          <p>Створення кола активних молодих людей з сильною проактивною та моральною позицією в суспільстві.</p>
        </div>
      </div>
    </div>
  </div>
